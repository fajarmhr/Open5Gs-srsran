...
class n2_enb(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "N2 Handover Flowgraph", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("N2 Handover Flowgraph")
        ...
        self.settings = Qt.QSettings("GNU Radio", "n2_enb")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 11.52e6
        self.cell_gain1 = cell_gain1 = 1
        self.cell_gain0 = cell_gain0 = 0.4
        ...
        self._cell_gain0_range = Range(0, 1, 0.1, 0.4, 200)
...
def main(top_block_cls=n2_enb, options=None):
